...
class Category
{
     ...
     * @Assert\Length(
     *     max=50,
     *     maxMessage="category.name.maxLength"
     * )
     */
    private $name;
     ...
     * @Assert\Length(
     *     max=300,
     *     maxMessage="category.description.maxLength"
     * )
     */
    private $description;
     ...
     *
     * @Vich\UploadableField(mapping="categories_thumbnail", fileNameProperty="imageName", size="imageSize", originalName="originalName", mimeType="mimeType")
     *
     * @var File|null
     */
    private $imageFile;
